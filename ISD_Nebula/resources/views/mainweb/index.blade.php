...
<head>
    ...
    <!-- font icons -->
    <link rel="stylesheet" href="mainweb/assets/vendors/themify-icons/css/themify-icons.css">
    <!-- Bootstrap + Rubic main styles -->
	<link rel="stylesheet" href="mainweb/assets/css/rubic.css">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
        ...
        <div class="container">
            <div class="row justify-content-around">
                ...
                <div class="col-lg-4 d-none d-lg-block align-self-center">
                    <img src="mainweb/assets/imgs/eiffel-tower.svg" alt="" class="w-100 tower">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-5 align-self-center mb-4 mb-md-0">
                    <img src="mainweb/assets/imgs/img.jpg" alt="" class="shadow w-100">
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-5 mt-4 mt-md-0">
                    <img src="mainweb/assets/imgs/img1.jpg" alt="" class="shadow w-100">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row text-left">
                <div class="col-md-4">
                    <div class="testmonial">
                        ...
                        <div class="media">
                            <img class="mr-3" src="mainweb/assets/imgs/avatar1.jpg" width="60" alt="Generic placeholder image">
                            <div class="media-body">
                ...
                <div class="col-md-4">
                    <div class="testmonial">
                        <p class="description"><i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, eaque, repellat. Corporis facilis reprehenderit, cupiditate.</i></p>
                        <div class="media">
                            <img class="mr-3" src="mainweb/assets/imgs/avatar2.jpg" width="60" alt="Generic placeholder image">
                            <div class="media-body">
                ...
                <div class="col-md-4">
                    <div class="testmonial">
                        <p class="description"><i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, eaque, repellat. Corporis facilis reprehenderit, cupiditate.</i></p>
                        <div class="media">
                            <img class="mr-3" src="mainweb/assets/imgs/avatar3.jpg" width="60" alt="Generic placeholder image">
                            <div class="media-body">
	...
	<!-- core  -->
    <script src="mainweb/assets/vendors/jquery/jquery-3.4.1.js"></script>
    <script src="mainweb/assets/vendors/bootstrap/bootstrap.bundle.js"></script>
    <!-- bootstrap 3 affix -->
	<script src="mainweb/assets/vendors/bootstrap/bootstrap.affix.js"></script>

    <!-- Rubic js -->
    <script src="mainweb/assets/js/rubic.js"></script>
