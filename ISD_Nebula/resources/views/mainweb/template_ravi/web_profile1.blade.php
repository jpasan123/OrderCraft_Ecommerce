                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-1.jpg" alt="notification user image">
                                                </div>
                                            </div>
                            ...
                            <li class="nav-item s-nav nav-icon dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right settings-dropdown shadow-sm" aria-labelledby="settings-dropdown">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/settings.png" alt="Navbar icon"> Settings</a>
                    ...
                    <div class="user-profile">
                        <div class="profile-header-background">
                            <a href="#" class="profile-cover">
                                <img src="home/images/imagesrp/users/cover/cover1.jpg" alt="Profile Header Background">
                                ...
                                <div class="profile-info-left  ">
                                    <div class="text-center ">
                                        <div class="profile-img w-shadow ">
                                            ...
                                            <img src="home/images/imagesrp/users/user-1.jpg" alt="Avatar" class="avatar img-circle">
                            ...
                            <div class="col-md-9 p-0">
                                <div class="profile-info-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 profile-center">
                                            ...
                                            <div class="post border-bottom p-3 bg-white w-shadow">
                                                <div class="media text-muted pt-3">
                                                    <img src="home/images/imagesrp/users/user-1.jpg" alt="Online user" class="mr-3 post-user-image">
                                                                        ...
                                                                        <ul class="media-list comments-list">
                                                                            <li class="media comment-form">
                                                                                <a href="#" class="pull-left">
                                                                                    <img src="home/images/imagesrp/users/user-1.jpg" alt="" class="img-circle">
                                                                                </a>
                                                                                <div class="media-body">
                                        ...
                                        <div class="col-md-3 profile-quick-media" style="position:sticky;">
