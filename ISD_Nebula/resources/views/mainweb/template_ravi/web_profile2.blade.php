                    ...
                    <div class="user-profile">
                        <div class="profile-header-background">
                            <a href="#" class="profile-cover">
                                <img src="home/images/imagesrp/users/cover/cover2.jpg" alt="Profile Header Background">
                                ...
                                <div class="profile-info-left">
                                    <div class="text-center">
                                      <div class="profile-img w-shadow" style="width: 150px; height: 150px; border-radius: 0">
                                            ...
                                            <img src="home/images/imagesrp/users/user-2.jpg" alt="Avatar" class="avatar rounded-0">
                                        ...
                                        <p class="profile-username mb-3 text-muted">@lucas_bennett</p>
                                    </div>
                                    ...
                                    <div class="intro mt-5 mv-hidden">
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                 <h3 class="intro-about">Mutual Friends</h3>
                                            </div>
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                <div class="friend-avatar">
                                                    <img src="https://bootdey.com/img/Content/user_2.jpg" alt="" class="img-circle">
                                                </div>
                                                <p class="intro-title text-muted">Friend 1 name</p>
                                            </div>
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                <div class="friend-avatar">
                                                    <img src="https://bootdey.com/img/Content/user_1.jpg" alt="" class="img-circle">
                                                 </div>
                                                 <p class="intro-title text-muted">Friend 2 name</p>
                                            </div>
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                <div class="friend-avatar">
                                                    <img src="https://bootdey.com/img/Content/user_3.jpg" alt="" class="img-circle">
                                                 </div>
                                                 <p class="intro-title text-muted">Friend 3 name</p>
                                            </div>
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                <div class="friend-avatar">
                                                    <img src="https://bootdey.com/img/Content/user_1.jpg" alt="" class="img-circle">
                                                 </div>
                                                 <p class="intro-title text-muted">Friend 4 name</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-9 profile-center">
                                            ...
                                            <div class="post border-bottom p-3 bg-white w-shadow">
                                                <div class="media text-muted pt-3">
                                                    <img src="home/images/imagesrp/users/user-2.jpg" alt="Online user" class="mr-3 post-user-image">
