                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item s-nav nav-icon dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right settings-dropdown shadow-sm" aria-labelledby="settings-dropdown">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/gear1.png" alt="Navbar icon"> Settings</a>
                    ...
                    <div class="user-profile">
                        <div class="profile-header-background">
                            <a href="#" class="profile-cover">
                                <img src="home/images/imagesrp/users/cover/cover3.jpg" alt="Profile Header Background">
                                ...
                                <div class="profile-info-left" style="margin-top: -100px;">
                                <div class="text-center">
                                        <div class="profile-img w-shadow">
                                            <div class="profile-img-overlay"></div>
                                            <img src="home/images/imagesrp/users/user-3.jpg" alt="Avatar" class="avatar img-circle" style="width: 150px; height: 150px;">
                            ...
                            <div class="col-md-9 p-0" style="margin-top: 10px;">
                                <div class="profile-info-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 profile-center">
                                            ...
                                            <div class="post border-bottom p-3 bg-white w-shadow">
                                                <div class="media text-muted pt-3">
                                                    <img src="home/images/imagesrp/users/user-3.jpg" alt="Online user" class="mr-3 post-user-image">
                                                                        ...
                                                                        <ul class="media-list comments-list">
                                                                            <li class="media comment-form">
                                                                                <a href="#" class="pull-left">
                                                                                    <img src="home/images/imagesrp/users/user-3.jpg" alt="" class="img-circle">
                                                                                </a>
                                                                                <div class="media-body">
                                        ...
                                        <div class="intro mt-5 mv-hidden"  >
                                            <div class="intro-item d-flex justify-content-between align-items-center" style="margin-top: -150px;">
