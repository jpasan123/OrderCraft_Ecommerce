...
<head>
    ...
    <link rel="stylesheet" href="home/css/vendors/themify-icons/css/themify-icons.css">

    <!-- Styles -->
    <link href="home/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="home/css/rubic.css" rel="stylesheet">
    <link href="home/css/components.css" rel="stylesheet">
    <link href="home/css/profile.css" rel="stylesheet">
    <link href="home/css/media.css" rel="stylesheet">
    <script src="home/js/load.js" type="text/javascript"></script>
</head>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <a href="#" class="nav-link nav-icon nav-links drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Create" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img src="home/images/imagesrp/icons/navbar/create.png" alt="navbar icon">
                                </a>
                                ...
                                <a href="#" class="nav-link nav-links message-drop drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Messages" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img src="home/images/imagesrp/icons/navbar/message.png" class="message-dropdown" alt="navbar icon"> <span class="badge badge-pill badge-primary">1</span>
                                </a>
                                <ul class="dropdown-menu notify-drop dropdown-menu-right nav-drop">
                                    ...
                                    <div class="drop-content">
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-3.jpg" alt="notification user image">
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-5.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-7.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-8.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-9.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-10.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                ...
                                <a href="#" class="nav-link nav-links rm-drop-mobile drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Notifications" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img src="home/images/imagesrp/icons/navbar/notification.png" class="notification-bell" alt="navbar icon"> <span class="badge badge-pill badge-primary">3</span>
                                </a>
                                <ul class="dropdown-menu notify-drop dropdown-menu-right nav-drop">
                                    <div class="notify-drop-title">
                                        <div class="row">
                                    ...
                                    <div class="drop-content">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-11.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                        ...
                                        <li>
                                            <div class="col-md-2 col-sm-2 col-xs-2">
                                                <div class="notify-img">
                                                    <img src="home/images/imagesrp/users/user-12.png" alt="notification user image">
                                                </div>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                            ...
                            <li class="nav-item s-nav dropdown d-mobile">
                                <a href="#" class="nav-link nav-links nav-icon drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Pages" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img src="home/images/imagesrp/icons/navbar/flag.png" alt="navbar icon">
                                </a>
                            ...
                            <li class="nav-item s-nav nav-icon dropdown">
                                <a href="settings.html" data-toggle="dropdown" data-placement="bottom" data-title="Settings" class="nav-link settings-link rm-drop-mobile drop-w-tooltip" id="settings-dropdown"><img src="home/images/imagesrp/icons/navbar/settings.png" class="nav-settings" alt="navbar icon"></a>
                                <div class="dropdown-menu dropdown-menu-right settings-dropdown shadow-sm" aria-labelledby="settings-dropdown">
                                    <a class="dropdown-item" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/help.png" alt="Navbar icon"> Help Center</a>
                                    <a class="dropdown-item d-flex align-items-center dark-mode" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/moon.png" alt="Navbar icon"> Dark Mode
                                        <button type="button" class="btn btn-lg btn-toggle ml-auto" data-toggle="button" aria-pressed="false" autocomplete="off">
                                            <div class="handle"></div>
                                        </button>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/gear-1.png" alt="Navbar icon"> Settings</a>
                                    <a class="dropdown-item logout-btn" href="#">
                                        <img src="home/images/imagesrp/icons/navbar/logout.png" alt="Navbar icon"> Log Out</a>
                                </div>
                            </li>
                            </ul>
                        </div>
                    ...
                    <div class="user-profile">
                        <div class="profile-header-background">
                            <a href="#" class="profile-cover">
                                <img src="home/images/imagesrp/users/cover/cover4.jpg" alt="Profile Header Background">
                                <div class="cover-overlay">
                                    
                                </div>

                                <div class="profile-info-left" style="margin-top: -70px;">
                                <div class="text-center">
                                        <div class="profile-img w-shadow " style="width: 150px; height: 150px; border-radius: 0" >
                                            <div class="profile-img-overlay" style="border-radius: 10px;"></div>
                                            <img src="home/images/imagesrp/users/user-4.jpg" alt="Avatar" class="avatar img-circle" style="width: 150px; height: 150px; border-radius: 0">
                                            ...
                                            <p class="profile-fullname mt-3">Lucas Bennett</p>
                                            <p class="profile-username mb-3 text-muted">my vision</p>
                        ...
                        <div class="row profile-rows">
                            <div class="col-md-3" style="margin-top: -150px;">
                                <div class="profile-info-left" >
                                    ...
                                    <div class="intro mt-5 mv-hidden">
                                        ...
                                        <div class="intro-item d-flex justify-content-between align-items-center">
                                            <p class="intro-title text-muted"><i class='bx bx-id-card text-primary'></i> ID Number <a href="#">######</a></p>
                                        </div>
                                        <div class="intro-item d-flex justify-content-between align-items-center">
                                            <p class="intro-title text-muted"><i class='bx bx-phone text-primary'></i> Contact Details <a href="#">phone Number</a></p>
                                        </div>
                                        <div class="intro-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-9 p-0" style="margin-top: 10px;">
                                <div class="profile-info-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 profile-center">
                                            ...
                                            <div class="post border-bottom p-3 bg-white w-shadow">
                                                <div class="media text-muted pt-3">
                                                    <img src="home/images/imagesrp/users/user-4.jpg" alt="Online user" class="mr-3 post-user-image">
                                                    <div class="media-body pb-3 mb-0 small lh-125">
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            <span class="post-type text-muted"><a href="#" class="text-gray-dark post-user-name mr-2">Lucas Bennett</a> updated his cover photo.</span>
                                                            <div class="dropdown">
                                                ...
                                                <div class="d-block mt-3">
                                                    <img src="home/images/imagesrp/users/post/post-1.jpg" class="w-100 mb-3" alt="post image">
                                                </div>
                                                <div class="mb-2">
                                                                        ...
                                                                        <ul class="media-list comments-list">
                                                                            <li class="media comment-form">
                                                                                <a href="#" class="pull-left">
                                                                                    <img src="home/images/imagesrp/users/user-4.jpg" alt="" class="img-circle">
                                                                                </a>
                                                                                <div class="media-body">
                                                                            ...
                                                                            <li class="media">
                                                                                <a href="#" class="pull-left">
                                                                                    <img src="home/images/imagesrp/users/user-2.jpg" alt="" class="img-circle">
                                                                                </a>
                                                                                <div class="media-body">
                                                                                    <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <div class="col-md-4">
                                            <img src="home/images/imagesrp/users/album/album-1.jpg" width="95" alt="">
                                        </div>
                                        <div class="col-md-4">
                                            <img src="home/images/imagesrp/users/album/album-2.jpg" width="95" alt="">
                                        </div>
                                        <div class="col-md-4">
                                            <img src="home/images/imagesrp/users/album/album-3.jpg" width="95" alt="">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3 profile-quick-media"  style="margin-top: -150px;">
                                            <h5 class="text-muted timeline-title">Recent Media</h5>
                                            <div class="quick-media">
                                                <div class="media-overlay"></div>
                                                <a href="#" class="quick-media-img"><img src="home/images/imagesrp/users/album/album-1.jpg" alt="Quick media"></a>
                                                <div class="media-overlay-content">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="media-overlay-owner">
                                                            <img src="home/images/imagesrp/users/user-12.png" alt="Media owner image">
                                                    ...
                                                    <div class="overlay-bottom d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="liked-users">
                                                            <img src="home/images/imagesrp/users/user-9.png" alt="Liked users">
                                                            <img src="home/images/imagesrp/users/user-6.png" alt="Liked users">
                                                            <img src="home/images/imagesrp/users/user-12.png" alt="Liked users">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="quick-media">
                                                <div class="media-overlay"></div>
                                                <a href="#" class="quick-media-img"><img src="home/images/imagesrp/users/album/album-2.jpg" alt="Quick media"></a>
                                                <div class="media-overlay-content">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="media-overlay-owner">
                                                            <img src="home/images/imagesrp/users/user-12.png" alt="Media owner image">
                                            ...
                                            <div class="quick-media">
                                                <div class="media-overlay"></div>
                                                <a href="#" class="quick-media-img"><img src="home/images/imagesrp/users/album/album-3.jpg" alt="Quick media"></a>
                                                <div class="media-overlay-content">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="media-overlay-owner">
                                                            <img src="home/images/imagesrp/users/user-12.png" alt="Media owner image">
