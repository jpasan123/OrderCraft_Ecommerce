...
<head>
    ...
    <link rel="stylesheet" href="{{asset('ecommerce/mens.css')}}">
    <!-- Favicons -->
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="{{asset('storage/'.$pre_item->main_img)}}" width="100%" id="MainImg" alt="">
        </div>
        <div class="single-pro-details">
            ...
            <form method="POST" action="{{url('/add_to_cart/'.$pre_item->id)}}">
                ...
                <div class="form-group">
                    <input class="form-control" name="quantity" type="number" value="1" max="{{$pre_item->quantity}}" min="0">
                </div>
                <br>
    ...
    <script src="{{asset('ecommerce/mens.js')}}"></script>
