...
<body>
    ...
    <div class="container_login">
        ...
        @endif
        <form action="{{ url('/ecomm_admin_signup') }}" method="POST" onsubmit="return validatePassword();">
            @csrf
            @if (session('success'))
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" placeholder="Minimum Six characters with a number and letter" required>
            </div>
            <div class="form-group">
                <div id="passwordError" class="error-message"></div>
                <label for="confirmPassword"><b>Confirm Password:</b></label>
                <input type="password" id="confirmPassword" name="password_confirmation" placeholder="Re-enter Your Password" required>
            </div>
            <div class="form-group">
                <div id="confirmPasswordError" class="error-message"></div>
            </div>
            <button type="submit">Signup</button>
            <p>Return To Admin Dashboard ? <a href="{{ url('/ecomm_admin_dash') }}">Return</a></p>
        </form>
    </div>
