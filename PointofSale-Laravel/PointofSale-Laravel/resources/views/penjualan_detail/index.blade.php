                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <input type="hidden" name="id_penjualan" id="id_penjualan" onclick="tampilProduk()" value="{{ $id_penjualan }}">
                                <input type="hidden" name="id_produk" id="id_produk" onclick="tampilProduk()">
                                <input type="text" class="form-control" name="kode_produk" id="kode_produk" onclick="tampilProduk()">
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $.get(`{{ url('/transaksi/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
                ...
                $('.tampil-bayar').text('Pay: Rs. '+ response.bayarrp);
                $('.tampil-terbilang').text(response.terbilang);

                $('#kembali').val('Rs.'+ response.kembalirp);
                if ($('#diterima').val() != 0) {
                    $('.tampil-bayar').text('Return: Rs. '+ response.kembalirp);
